ArcGIS 10.4.x GeoEvent Big File Transport

## Features
* Extension to regular file input transport to support large files
* Supports Flush Interval, Max Number of Lines Per Flush, Ignore the first line parameters to read data in a "paging" way.
